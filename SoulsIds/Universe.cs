...
namespace SoulsIds
{
  public class Universe
  {
    ...
    private static HashSet<Universe.Namespace> Quotes = new HashSet<Universe.Namespace>()
    {
    ...
    public readonly Dictionary<Universe.Obj, Universe.Node> Nodes = new Dictionary<Universe.Obj, Universe.Node>();
    public readonly Dictionary<Universe.Obj, string> Names = new Dictionary<Universe.Obj, string>();

    public string Name(Universe.Obj obj)
    {
      string str;
      return this.Names.TryGetValue(obj, out str) ? string.Format("{0}:{1}", (object) obj, Universe.Quotes.Contains(obj.Type) ? (object) ("\"" + str + "\"") : (object) str) : string.Format("{0}", (object) obj);
    }
    ...
    {
      return !this.Nodes.ContainsKey(obj) ? new List<Universe.Obj>() : this.Nodes[obj].To.Where<Universe.Relation>((Func<Universe.Relation, bool>) (r => r.Verb == v && r.To.HasType(type))).Select<Universe.Relation, Universe.Obj>((Func<Universe.Relation, Universe.Obj>) (r => r.To)).ToList<Universe.Obj>();
    }
    ...
    public List<Universe.Obj> Prev(
      ...
      Universe.Namespace type = Universe.Namespace.GLOBAL)
    {
      return !this.Nodes.ContainsKey(obj) ? new List<Universe.Obj>() : this.Nodes[obj].From.Where<Universe.Relation>((Func<Universe.Relation, bool>) (r => r.Verb == v && r.From.HasType(type))).Select<Universe.Relation, Universe.Obj>((Func<Universe.Relation, Universe.Obj>) (r => r.From)).ToList<Universe.Obj>();
    }
    ...
    public List<Universe.Obj> Connected(Universe.Obj obj, Universe.RelationSpec rel)
    {
      return !rel.Subject ? this.Prev(obj, rel.Verb, rel.Type) : this.Next(obj, rel.Verb, rel.Type);
    }
    ...
    public class Obj : IComparable<Universe.Obj>
    {
      ...
      {
        return this.Type.ToString().ToLower() + ":" + this.ID + (this.RangeEnd == -1 ? "" : string.Format(":{0}", (object) this.RangeEnd));
      }
      ...
      {
        return this.Type == o.Type && this.ID.Equals(o.ID) && this.RangeEnd == o.RangeEnd;
      }
      ...
      public int CompareTo(Universe.Obj o)
      {
        ...
        int result1;
        int result2;
        return int.TryParse(this.ID, out result1) && int.TryParse(o.ID, out result2) ? Universe.Nest(result1.CompareTo(result2), this.RangeEnd.CompareTo(o.RangeEnd)) : Universe.Nest(this.ID.CompareTo(o.ID), this.RangeEnd.CompareTo(o.RangeEnd));
      }
      ...
      public bool HasType(Universe.Namespace n)
      {
        switch (n)
        {
          ...
          case Universe.Namespace.ITEM:
            return this.Type >= Universe.Namespace.WEAPON && this.Type <= Universe.Namespace.GOODS;
          default:
            return n == this.Type;
        }
      }
      ...
      {
        return new Universe.Obj((object) id, Universe.Namespace.EVENT_FLAG, end);
      }
      ...
      {
        return new Universe.Obj((object) (map + "_" + id), Universe.Namespace.PART, -1);
      }
      ...
      {
        return new Universe.Obj((object) string.Format("{0}_{1}", (object) map, (object) index), Universe.Namespace.TREASURE, -1);
      }
      ...
      {
        Universe.Namespace Type = type <= 4U ? (Universe.Namespace) (10 + (int) type) : (Universe.Namespace) (10 + Universe.LotTypes[type]);
    ...
    public class PartialRelation
    {
      ...
      public static Universe.PartialRelation Verbs(Universe.Verb verb, Universe.Obj obj)
      {
      ...
      public static Universe.PartialRelation VerbedBy(Universe.Obj obj, Universe.Verb verb)
      {
        return new Universe.PartialRelation()
        {
          Obj = obj,
      ...
      {
        return this.Obj.Equals(o.Obj) && this.Verb == o.Verb && this.Subject == o.Subject;
      }

      public override int GetHashCode()
      {
        return (int) this.Verb << 24 ^ this.Obj.GetHashCode() ^ (this.Subject ? 0 : (int) ushort.MaxValue);
      }
    }
    ...
    public class RelationSpec
    {
      ...
      public static Universe.RelationSpec Verbs(Universe.Verb verb, Universe.Namespace type = Universe.Namespace.GLOBAL)
      {
