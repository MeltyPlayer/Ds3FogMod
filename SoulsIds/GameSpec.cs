...
namespace SoulsIds
{
  ...
  {
    private static readonly Dictionary<GameSpec.FromGame, GameSpec> Games = new Dictionary<GameSpec.FromGame, GameSpec>()
    {
    ...
    {
      GameSpec gameSpec1;
      GameSpec gameSpec2 = GameSpec.Games.TryGetValue(game, out gameSpec1) ? gameSpec1.Clone() : new GameSpec();
      gameSpec2.Game = game;
      return gameSpec2;
    }
