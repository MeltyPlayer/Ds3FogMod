...
namespace SoulsIds {
  public class EMEDF {
    ...
    [JsonProperty(PropertyName = "enums")] public EMEDF.EnumDoc[] Enums;

    public EMEDF.ClassDoc this[int classIndex] {
      get {
        return this.Classes.Find(
            (Predicate<EMEDF.ClassDoc>) (c => c.Index ==
                                              (long) classIndex));
      }
    }
    ...
    public class ClassDoc {
      ...
      [JsonProperty(PropertyName = "index")] public long Index { get; set; }
      ...
      public EMEDF.InstrDoc this[int instructionIndex] {
        get {
          return this.Instructions.Find(
              (Predicate<EMEDF.InstrDoc>) (ins => ins.Index ==
                                                  (long)
                                                  instructionIndex
                                          ));
        }
    ...
    public class InstrDoc {
      ...
      public EMEDF.ArgDoc this[uint i] {
        get { return this.Arguments[(int) i]; }
      }
    }
    ...
    public class ArgDoc {
      ...
      [JsonProperty(PropertyName = "type")] public long Type { get; set; }
      ...
      [JsonProperty(PropertyName = "min")] public long Min { get; set; }

      [JsonProperty(PropertyName = "max")] public long Max { get; set; }
      ...
      [JsonProperty(PropertyName = "unk1")] private long UNK1 { get; set; }

      [JsonProperty(PropertyName = "unk2")] private long UNK2 { get; set; }

      [JsonProperty(PropertyName = "unk3")] private long UNK3 { get; set; }

      [JsonProperty(PropertyName = "unk4")] private long UNK4 { get; set; }
    }
