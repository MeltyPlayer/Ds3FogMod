  ...
  public static class DCX {
    ...
    private static byte[] DecompressDCXDFLT(
      ...
      if (type == DCX.Type.DCX_DFLT_10000_24_9) {
        br.AssertInt32(36);
        br.AssertInt32(44);
      } else if (type == DCX.Type.DCX_DFLT_10000_44_9 ||
                 type == DCX.Type.DCX_DFLT_11000_44_8 ||
                 type == DCX.Type.DCX_DFLT_11000_44_9) {
        br.AssertInt32(68);
        br.AssertInt32(76);
    ...
    internal static void Compress(
      ...
      if (type == DCX.Type.Zlib)
      ...
      else if (type == DCX.Type.DCX_DFLT_10000_24_9 ||
               type == DCX.Type.DCX_DFLT_10000_44_9 ||
               (type == DCX.Type.DCX_DFLT_11000_44_8 ||
                type == DCX.Type.DCX_DFLT_11000_44_9))
        ...
        if (type == DCX.Type.Unknown)
          throw new ArgumentException(
              "You cannot compress a DCX with an unknown type.");
    ...
    private static void CompressDCXEDGE(byte[] data, BinaryWriterEx bw) {
      ...
      for (int index = 0; index < num1; ++index) {
        ...
        using (MemoryStream memoryStream1 = new MemoryStream()) {
          using (MemoryStream memoryStream2 =
              new MemoryStream(data, index * 65536, count)) {
            DeflateStream deflateStream =
                new DeflateStream((Stream) memoryStream1,
        ...
        num2 += bytes.Length;
        bw.FillInt32(string.Format("ChunkOffset{0}", (object) index),
                     (int) (bw.Position - position3));
        bw.FillInt32(string.Format("ChunkSize{0}", (object) index),
                     bytes.Length);
        bw.WriteBytes(bytes);
        bw.Pad(16);
      }
    ...
    private static void CompressDCXKRAK(byte[] data, BinaryWriterEx bw) {
      byte[] bytes = Oodle26.Compress(data,
                                      Oodle26.Compressor.Kraken,
                                      Oodle26.CompressionLevel.Optimal2);
      bw.WriteASCII("DCX\0", false);
      bw.WriteInt32(69632);
      bw.WriteInt32(24);
      bw.WriteInt32(36);
