...
namespace SoulsFormats
{
  ...
  public class NVA : SoulsFile<NVA>
  {
    ...
    protected override void Read(BinaryReaderEx br)
    {
      ...
      NVA.ConnectorConditionSection conds = new NVA.ConnectorConditionSection(br);
      this.Entries7 = new NVA.Section7(br);
      NVA.MapNodeSection entries8 = this.Version != NVA.NVAVersion.OldBloodborne ? new NVA.MapNodeSection(br) : new NVA.MapNodeSection(1);
    ...
    protected override void Write(BinaryWriterEx bw)
    {
      ...
      NVA.MapNodeSection mapNodes = new NVA.MapNodeSection(this.Version == NVA.NVAVersion.Sekiro ? 2 : 1);
      foreach (NVA.Navmesh navmesh in (List<NVA.Navmesh>) this.Navmeshes)
    ...
    public class Navmesh
    {
      ...
      internal Navmesh(BinaryReaderEx br, int version)
      {
        ...
        if (version < 4)
        {
          ...
          this.NameReferenceIDs = new List<int>((IEnumerable<int>) br.ReadInt32s(count));
        ...
        else
        {
          ...
          br.AssertInt32(new int[1]);
          br.AssertInt32(new int[1]);
          this.NameReferenceIDs = new List<int>((IEnumerable<int>) br.GetInt32s((long) num2, count));
        }
      }
      ...
      internal void Write(BinaryWriterEx bw, int version, int index)
      {
        ...
        if (version < 4)
        {
          ...
          for (int index1 = 0; index1 < 16 - this.NameReferenceIDs.Count; ++index1)
            bw.WriteInt32(-1);
        }
        else
        {
      ...
      internal void WriteNameRefs(BinaryWriterEx bw, int version, int index)
      {
        if (version < 4)
          return;
        bw.FillInt32(string.Format("NameRefOffset{0}", (object) index), (int) bw.Position);
        bw.WriteInt32s((IList<int>) this.NameReferenceIDs);
      }
      ...
      {
        return string.Format("{0} {1} {2} [{3} References] [{4} MapNodes]", (object) this.NameID, (object) this.Position, (object) this.Rotation, (object) this.NameReferenceIDs.Count, (object) this.MapNodes.Count);
      }
    }
    ...
    public class Entry2
    {
      ...
      public override string ToString()
      {
        return string.Format("{0} {1} [{2} References]", (object) this.Unk00, (object) this.Unk08, (object) this.References.Count);
      }
      ...
      public class Reference
      {
        ...
        public override string ToString()
        {
          return string.Format("{0} {1}", (object) this.UnkIndex, (object) this.NameID);
        }
      }
    }
    ...
    public class Connector
    {
      ...
      public override string ToString()
      {
        return string.Format("{0} -> {1} [{2} Points][{3} Conditions]", (object) this.MainNameID, (object) this.TargetNameID, (object) this.Points.Count, (object) this.Conditions.Count);
      }
    }
    ...
    internal class ConnectorPointSection : NVA.Section<NVA.ConnectorPoint>
    {
      ...
      internal override void WriteEntries(BinaryWriterEx bw)
      {
        foreach (NVA.ConnectorPoint connectorPoint in (List<NVA.ConnectorPoint>) this)
    ...
    public class ConnectorPoint
    {
      ...
      public override string ToString()
      {
        return string.Format("{0} {1} {2} {3}", (object) this.Unk00, (object) this.Unk04, (object) this.Unk08, (object) this.Unk0C);
      }
    }

    internal class ConnectorConditionSection : NVA.Section<NVA.ConnectorCondition>
    {
      ...
      internal override void WriteEntries(BinaryWriterEx bw)
      {
        foreach (NVA.ConnectorCondition connectorCondition in (List<NVA.ConnectorCondition>) this)
    ...
    public class ConnectorCondition
    {
      ...
      public override string ToString()
      {
        return string.Format("{0} {1}", (object) this.Condition1, (object) this.Condition2);
      }
    }
    ...
    public class Entry7
    {
      ...
      public override string ToString()
      {
        return string.Format("{0} {1} {2}", (object) this.Position, (object) this.NameID, (object) this.Unk18);
      }
    }
    ...
    public class MapNode
    {
      ...
      internal MapNode(BinaryReaderEx br, int version)
      {
        ...
        if (version < 2)
        {
          this.SiblingDistances = new List<float>(((IEnumerable<ushort>) br.ReadUInt16s(16)).Select<ushort, float>((Func<ushort, float>) (s => s != ushort.MaxValue ? (float) s * 0.01f : -1f)));
        }
        else
        {
          int count = br.ReadInt32();
          ...
          int num = br.ReadInt32();
          br.AssertInt32(new int[1]);
          this.SiblingDistances = new List<float>(((IEnumerable<ushort>) br.GetUInt16s((long) num, count)).Select<ushort, float>((Func<ushort, float>) (s => s != ushort.MaxValue ? (float) s * 0.01f : -1f)));
        }
      }
      ...
      internal void Write(BinaryWriterEx bw, int version, int index)
      {
        ...
        if (version < 2)
        {
          ...
          foreach (float siblingDistance in this.SiblingDistances)
            bw.WriteUInt16((double) siblingDistance == -1.0 ? ushort.MaxValue : (ushort) Math.Round((double) siblingDistance * 100.0));
          for (int index1 = 0; index1 < 16 - this.SiblingDistances.Count; ++index1)
      ...
      internal void WriteSubIDs(BinaryWriterEx bw, int version, int index)
      {
        if (version < 2)
          return;
        bw.FillInt32(string.Format("SubIDsOffset{0}", (object) index), (int) bw.Position);
        foreach (float siblingDistance in this.SiblingDistances)
          bw.WriteUInt16((double) siblingDistance == -1.0 ? ushort.MaxValue : (ushort) Math.Round((double) siblingDistance * 100.0));
      }
      ...
      public override string ToString()
      {
        return string.Format("{0} {1} {2} [{3} SubIDs]", (object) this.Position, (object) this.Section0Index, (object) this.MainID, (object) this.SiblingDistances.Count);
      }
    }
  }
}
