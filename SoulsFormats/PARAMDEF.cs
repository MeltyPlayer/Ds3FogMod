...
namespace SoulsFormats
{
  ...
  public class PARAMDEF : SoulsFile<PARAMDEF>
  {
    ...
    protected override void Read(BinaryReaderEx br)
    {
      ...
      short num3 = br.AssertInt16((short) 108, (short) 140, (short) 172, (short) 176, (short) 208);
      this.ParamType = br.ReadFixStr(32);
      int num4 = (int) br.ReadByte();
      this.Unicode = br.ReadBoolean();
      this.Version = br.AssertInt16((short) 101, (short) 102, (short) 103, (short) 104, (short) 201);
      if (this.Version >= (short) 201)
        br.AssertInt64(56L);
      if ((this.Version >= (short) 200 || num1 != (short) 48) && (this.Version < (short) 200 || num1 != (short) byte.MaxValue))
        throw new InvalidDataException(string.Format("Unexpected unk04 0x{0:X} for version {1}.", (object) num1, (object) this.Version));
      if ((this.Version != (short) 101 || num3 != (short) 140) && (this.Version != (short) 102 || num3 != (short) 172) && ((this.Version != (short) 103 || num3 != (short) 108) && (this.Version != (short) 104 || num3 != (short) 176)) && (this.Version != (short) 201 || num3 != (short) 208))
        throw new InvalidDataException(string.Format("Unexpected field size 0x{0:X} for version {1}.", (object) num3, (object) this.Version));
    ...
    {
      if (this.Version != (short) 101 && this.Version != (short) 102 && (this.Version != (short) 103 && this.Version != (short) 104) && this.Version != (short) 201)
      {
        ex = (Exception) new InvalidDataException(string.Format("Unknown version: {0}", (object) this.Version));
        return false;
      }
      if (!SoulsFile<PARAMDEF>.ValidateNull((object) this.ParamType, "ParamType may not be null.", out ex) || !SoulsFile<PARAMDEF>.ValidateNull((object) this.Fields, "Fields may not be null.", out ex))
        return false;
      for (int index = 0; index < this.Fields.Count; ++index)
      {
        PARAMDEF.Field field = this.Fields[index];
        string str = string.Format("{0}[{1}]", (object) "Fields", (object) index);
        if (!SoulsFile<PARAMDEF>.ValidateNull((object) field, str + ": Field may not be null.", out ex) || !SoulsFile<PARAMDEF>.ValidateNull((object) field.DisplayName, str + ": DisplayName may not be null.", out ex) || (!SoulsFile<PARAMDEF>.ValidateNull((object) field.DisplayFormat, str + ": DisplayFormat may not be null.", out ex) || !SoulsFile<PARAMDEF>.ValidateNull((object) field.InternalType, str + ": InternalType may not be null.", out ex)) || this.Version >= (short) 102 && !SoulsFile<PARAMDEF>.ValidateNull((object) field.InternalName, string.Format("{0}: {1} may not be null on version {2}.", (object) str, (object) "InternalName", (object) this.Version), out ex))
          return false;
      }
      ex = (Exception) null;
      return true;
    ...
    protected override void Write(BinaryWriterEx bw)
    {
      ...
      bw.WriteInt16(this.Version >= (short) 201 ? (short) byte.MaxValue : (short) 48);
      ...
      bw.WriteFixStr(this.ParamType, 32, this.Version >= (short) 201 ? (byte) 0 : (byte) 32);
    ...
    public int GetRowSize()
    {
      ...
      for (int index = 0; index < this.Fields.Count; ++index)
      {
        ...
        if (ParamUtil.IsBitType(displayType1) && field1.BitSize != -1)
        {
          ...
          PARAMDEF.DefType type = displayType1 == PARAMDEF.DefType.dummy8 ? PARAMDEF.DefType.u8 : displayType1;
          ...
          for (; index < this.Fields.Count - 1; ++index)
          {
            ...
            if (ParamUtil.IsBitType(displayType2) && field2.BitSize != -1 && bitSize + field2.BitSize <= bitLimit && (displayType2 == PARAMDEF.DefType.dummy8 ? PARAMDEF.DefType.u8 : displayType2) == type)
    ...
    private PARAMDEF(XmlDocument xml)
    {
      ...
      if (num != 0)
        throw new InvalidDataException(string.Format("Mismatched XML version; current version: {0}, file version: {1}", (object) 0, (object) num));
    ...
    public class Field
    {
      ...
      {
        this.DisplayName = !def.Unicode ? br.ReadFixStr(64) : br.ReadFixStrW(64);
        this.DisplayType = (PARAMDEF.DefType) System.Enum.Parse(typeof (PARAMDEF.DefType), br.ReadFixStr(8));
        ...
        if (!ParamUtil.IsArrayType(this.DisplayType) && num != ParamUtil.GetValueSize(this.DisplayType) || ParamUtil.IsArrayType(this.DisplayType) && num % ParamUtil.GetValueSize(this.DisplayType) != 0)
          throw new InvalidDataException(string.Format("Unexpected byte count {0} for type {1}.", (object) num, (object) this.DisplayType));
        this.ArrayLength = num / ParamUtil.GetValueSize(this.DisplayType);
        long offset = def.Version < (short) 201 ? (long) br.ReadInt32() : br.ReadInt64();
        ...
        if (def.Version >= (short) 102)
        {
          ...
          {
            Match match2 = PARAMDEF.Field.arrayLengthRx.Match(this.InternalName);
            if ((match2.Success ? int.Parse(match2.Groups["length"].Value) : 1) != this.ArrayLength)
              throw new InvalidDataException(string.Format("Mismatched array length in {0} with byte count {1}.", (object) this.InternalName, (object) num));
            if (match2.Success)
      ...
      {
        if (def.Unicode)
          bw.WriteFixStrW(this.DisplayName, 64, def.Version >= (short) 104 ? (byte) 0 : (byte) 32);
        else
          bw.WriteFixStr(this.DisplayName, 64, def.Version >= (short) 104 ? (byte) 0 : (byte) 32);
        ...
        if (def.Version >= (short) 201)
          bw.ReserveInt64(string.Format("DescriptionOffset{0}", (object) index));
        else
          bw.ReserveInt32(string.Format("DescriptionOffset{0}", (object) index));
        bw.WriteFixStr(this.InternalType, 32, padding);
        if (def.Version >= (short) 102)
        {
          string text = this.InternalName;
          if (this.BitSize != -1)
            text = string.Format("{0}:{1}", (object) text, (object) this.BitSize);
          else if (ParamUtil.IsArrayType(this.DisplayType))
            text = string.Format("{0}[{1}]", (object) text, (object) this.ArrayLength);
      ...
      internal void WriteDescription(BinaryWriterEx bw, PARAMDEF def, int index)
      {
        ...
        if (def.Version >= (short) 201)
          bw.FillInt64(string.Format("DescriptionOffset{0}", (object) index), num);
        else
          bw.FillInt32(string.Format("DescriptionOffset{0}", (object) index), (int) num);
      }

      public override string ToString()
      {
        if (ParamUtil.IsBitType(this.DisplayType) && this.BitSize != -1)
          return string.Format("{0} {1}:{2}", (object) this.DisplayType, (object) this.InternalName, (object) this.BitSize);
        return ParamUtil.IsArrayType(this.DisplayType) ? string.Format("{0} {1}[{2}]", (object) this.DisplayType, (object) this.InternalName, (object) this.ArrayLength) : string.Format("{0} {1}", (object) this.DisplayType, (object) this.InternalName);
      }
      ...
      internal Field(XmlNode node)
      {
        ...
        this.DisplayType = (PARAMDEF.DefType) System.Enum.Parse(typeof (PARAMDEF.DefType), match1.Groups["type"].Value.Trim());
        if (match1.Groups["default"].Success)
          this.Default = float.Parse(match1.Groups["default"].Value, (IFormatProvider) CultureInfo.InvariantCulture);
        ...
        this.DisplayName = node.ReadStringOrDefault(nameof (DisplayName), this.InternalName);
        this.InternalType = node.ReadStringOrDefault("Enum", this.DisplayType.ToString());
        this.Description = node.ReadStringOrDefault(nameof (Description), (string) null);
        this.DisplayFormat = node.ReadStringOrDefault(nameof (DisplayFormat), ParamUtil.GetDefaultFormat(this.DisplayType));
        this.EditFlags = (PARAMDEF.EditFlags) System.Enum.Parse(typeof (PARAMDEF.EditFlags), node.ReadStringOrDefault(nameof (EditFlags), ParamUtil.GetDefaultEditFlags(this.DisplayType).ToString()));
        this.Minimum = node.ReadSingleOrDefault(nameof (Minimum), ParamUtil.GetDefaultMinimum(this.DisplayType), (IFormatProvider) CultureInfo.InvariantCulture);
        this.Maximum = node.ReadSingleOrDefault(nameof (Maximum), ParamUtil.GetDefaultMaximum(this.DisplayType), (IFormatProvider) CultureInfo.InvariantCulture);
        this.Increment = node.ReadSingleOrDefault(nameof (Increment), ParamUtil.GetDefaultIncrement(this.DisplayType), (IFormatProvider) CultureInfo.InvariantCulture);
        this.SortID = node.ReadInt32OrDefault(nameof (SortID), 0);
      }

      internal void XmlSerialize(XmlWriter xw)
      {
        string str1 = string.Format("{0} {1}", (object) this.DisplayType, (object) this.InternalName);
        if (ParamUtil.IsBitType(this.DisplayType) && this.BitSize != -1)
          str1 += string.Format(":{0}", (object) this.BitSize);
        else if (ParamUtil.IsArrayType(this.DisplayType))
          str1 += string.Format("[{0}]", (object) this.ArrayLength);
        if ((double) this.Default != 0.0)
          str1 = str1 + " = " + this.Default.ToString("R", (IFormatProvider) CultureInfo.InvariantCulture);
        xw.WriteAttributeString("Def", str1);
        xw.WriteDefaultElement<string>("DisplayName", this.DisplayName, this.InternalName);
        xw.WriteDefaultElement<string>("Enum", this.InternalType, this.DisplayType.ToString());
        xw.WriteDefaultElement<string>("Description", this.Description, (string) null);
        xw.WriteDefaultElement<string>("DisplayFormat", this.DisplayFormat, ParamUtil.GetDefaultFormat(this.DisplayType));
        XmlWriter xw1 = xw;
        ...
        xw.WriteDefaultElement("Minimum", this.Minimum, ParamUtil.GetDefaultMinimum(this.DisplayType), "R", (IFormatProvider) CultureInfo.InvariantCulture);
        xw.WriteDefaultElement("Maximum", this.Maximum, ParamUtil.GetDefaultMaximum(this.DisplayType), "R", (IFormatProvider) CultureInfo.InvariantCulture);
        xw.WriteDefaultElement("Increment", this.Increment, ParamUtil.GetDefaultIncrement(this.DisplayType), "R", (IFormatProvider) CultureInfo.InvariantCulture);
