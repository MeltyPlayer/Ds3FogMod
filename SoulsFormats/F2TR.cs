  ...
  public class F2TR : SoulsFile<F2TR>
  {
    ...
    public class Entry
    {
      ...
      internal Entry(BinaryReaderEx br)
      {
        ...
        this.Indices = new List<short>((IEnumerable<short>) br.GetInt16s((long) num2, (int) num3));
      }
      ...
      {
        bw.FillInt32(string.Format("IndicesOffset{0}", (object) index), (int) bw.Position);
        bw.WriteInt16s((IList<short>) this.Indices);
      }

      internal void WriteName(BinaryWriterEx bw, int index)
      {
        bw.FillInt32(string.Format("NameOffset{0}", (object) index), (int) bw.Position);
