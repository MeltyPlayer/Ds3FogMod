...
namespace SoulsFormats
{
  ...
  public class FFXDLSE : SoulsFile<FFXDLSE>
  {
    ...
    {
      XmlSerializer[] xmlSerializerArray = XmlSerializer.FromTypes(new System.Type[3]
      {
        typeof (FFXDLSE),
    ...
    private static XmlSerializer FFXSerializer
    {
      get
      {
        return FFXDLSE._ffxSerializer ?? FFXDLSE.MakeSerializers(0);
      }
    }
    ...
    private static XmlSerializer StateSerializer
    {
      get
      {
        return FFXDLSE._stateSerializer ?? FFXDLSE.MakeSerializers(1);
      }
    }
    ...
    private static XmlSerializer ParamSerializer
    {
      get
      {
        return FFXDLSE._paramSerializer ?? FFXDLSE.MakeSerializers(2);
      }
    }
    ...
    public abstract class Evaluatable : FFXDLSE.FXSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializableEvaluatable<dl_int32>";
        }
      }
      ...
      internal static FFXDLSE.Evaluatable Read(BinaryReaderEx br, List<string> classNames)
      {
        int int32 = br.GetInt32(br.Position + 10L);
        switch (int32)
        {
          case 1:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableConstant(br, classNames);
          case 2:
            return (FFXDLSE.Evaluatable) new FFXDLSE.Evaluatable2(br, classNames);
          case 3:
            return (FFXDLSE.Evaluatable) new FFXDLSE.Evaluatable3(br, classNames);
          case 4:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableCurrentTick(br, classNames);
          case 5:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableTotalTick(br, classNames);
          case 8:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableAnd(br, classNames);
          case 9:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableOr(br, classNames);
          case 10:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableGE(br, classNames);
          case 11:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableGT(br, classNames);
          case 12:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableLE(br, classNames);
          case 13:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableLT(br, classNames);
          case 14:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableEQ(br, classNames);
          case 15:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableNE(br, classNames);
          case 20:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableNot(br, classNames);
          case 21:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableChildExists(br, classNames);
          case 22:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableParentExists(br, classNames);
          case 23:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableDistanceFromCamera(br, classNames);
          case 24:
            return (FFXDLSE.Evaluatable) new FFXDLSE.EvaluatableEmittersStopped(br, classNames);
          default:
            throw new NotImplementedException(string.Format("Unimplemented evaluatable opcode: {0}", (object) int32));
        }
      }
    }
    ...
    public class Evaluatable2 : FFXDLSE.Evaluatable
    {
      ...
      public override string ToString()
      {
        return string.Format("{{2: {0}, {1}}}", (object) this.Unk00, (object) this.ArgIndex);
      }
    }
    ...
    public class Evaluatable3 : FFXDLSE.Evaluatable
    {
      ...
      public override string ToString()
      {
        return string.Format("{{3: {0}, {1}}}", (object) this.Unk00, (object) this.ArgIndex);
      }
    }
    ...
    public class EvaluatableCurrentTick : FFXDLSE.Evaluatable
    {
      ...
      internal EvaluatableCurrentTick(BinaryReaderEx br, List<string> classNames)
        : base(br, classNames)
      {
      }
    ...
    public class EvaluatableAnd : FFXDLSE.EvaluatableBinary
    {
      ...
      public override string ToString()
      {
        return string.Format("({0}) && ({1})", (object) this.Left, (object) this.Right);
      }
    }
    ...
    public class EvaluatableChildExists : FFXDLSE.Evaluatable
    {
      ...
      internal EvaluatableChildExists(BinaryReaderEx br, List<string> classNames)
        : base(br, classNames)
      {
      }
    ...
    public class EvaluatableParentExists : FFXDLSE.Evaluatable
    {
      ...
      internal EvaluatableParentExists(BinaryReaderEx br, List<string> classNames)
        : base(br, classNames)
      {
      }
    ...
    public class EvaluatableDistanceFromCamera : FFXDLSE.Evaluatable
    {
      ...
      internal EvaluatableDistanceFromCamera(BinaryReaderEx br, List<string> classNames)
        : base(br, classNames)
      {
      }
    ...
    public class EvaluatableEmittersStopped : FFXDLSE.Evaluatable
    {
      ...
      internal EvaluatableEmittersStopped(BinaryReaderEx br, List<string> classNames)
        : base(br, classNames)
      {
      }
    ...
    private static class DLVector
    {
      ...
      {
        int num = (int) br.AssertInt16((short) (classNames.IndexOf(nameof (DLVector)) + 1));
    ...
    public abstract class FXSerializable
    {
      ...
      internal FXSerializable(BinaryReaderEx br, List<string> classNames)
      {
        ...
        int num1 = (int) br.AssertInt16((short) (classNames.IndexOf(this.ClassName) + 1));
      ...
      internal void Write(BinaryWriterEx bw, List<string> classNames)
      {
        ...
        bw.FillInt32(string.Format("{0:X}Length", (object) position), (int) (bw.Position - position));
      }
    ...
    public abstract class Param : FFXDLSE.FXSerializable
    {
      ...
      internal static FFXDLSE.Param Read(BinaryReaderEx br, List<string> classNames)
      {
        int int32 = br.GetInt32(br.Position + 10L);
        switch (int32)
        {
          ...
          default:
            throw new NotImplementedException(string.Format("Unimplemented param type: {0}", (object) int32));
        }
      }
    }
    ...
    public class ParamList : FFXDLSE.FXSerializable, IXmlSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializableParamList";
        }
      }
      ...
      void IXmlSerializable.ReadXml(XmlReader reader)
      {
        ...
        while (reader.IsStartElement("Param"))
          this.Params.Add((FFXDLSE.Param) FFXDLSE.ParamSerializer.Deserialize(reader));
      ...
      void IXmlSerializable.WriteXml(XmlWriter writer)
      {
        ...
        for (int index = 0; index < this.Params.Count; ++index)
          FFXDLSE.ParamSerializer.Serialize(writer, (object) this.Params[index]);
      }
    }
    ...
    public class PrimitiveInt : FFXDLSE.FXSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializablePrimitive<dl_int32>";
        }
      }
    ...
    public class PrimitiveFloat : FFXDLSE.FXSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializablePrimitive<dl_float32>";
        }
      }
    ...
    public class PrimitiveTick : FFXDLSE.FXSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializablePrimitive<FXTick>";
        }
      }
    ...
    public class PrimitiveColor : FFXDLSE.FXSerializable
    {
      internal override string ClassName
      {
        get
        {
          return "FXSerializablePrimitive<FXColorRGBA>";
        }
      }
    ...
    public class StateMap : FFXDLSE.FXSerializable, IXmlSerializable
    {
      ...
      void IXmlSerializable.ReadXml(XmlReader reader)
      {
        ...
        while (reader.IsStartElement("State"))
          this.States.Add((FFXDLSE.State) FFXDLSE.StateSerializer.Deserialize(reader));
        reader.ReadEndElement();
      }
      ...
      void IXmlSerializable.WriteXml(XmlWriter writer)
      {
        for (int index = 0; index < this.States.Count; ++index)
        {
          ...
          FFXDLSE.StateSerializer.Serialize(writer, (object) this.States[index]);
        }
      }
    }
