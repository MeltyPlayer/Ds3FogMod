...
namespace SoulsFormats
{
  ...
  public class GPARAM : SoulsFile<GPARAM>
  {
    ...
    protected override void Read(BinaryReaderEx br)
    {
      ...
      if (this.Game == GPARAM.GPGame.DarkSouls3 || this.Game == GPARAM.GPGame.Sekiro)
      {
      ...
      this.UnkBlock2 = br.GetBytes((long) offsets.Unk2, offsets.Unk3 - offsets.Unk2);
    ...
    protected override void Write(BinaryWriterEx bw)
    {
      ...
      for (int groupIndex = 0; groupIndex < this.Groups.Count; ++groupIndex)
        this.Groups[groupIndex].WriteHeader(bw, this.Game, groupIndex, position1);
      int position2 = (int) bw.Position;
      bw.FillInt32("ParamHeaderOffsetsOffset", position2);
      for (int groupIndex = 0; groupIndex < this.Groups.Count; ++groupIndex)
        this.Groups[groupIndex].WriteParamHeaderOffsets(bw, groupIndex, position2);
      int position3 = (int) bw.Position;
      bw.FillInt32("ParamHeadersOffset", position3);
      for (int groupindex = 0; groupindex < this.Groups.Count; ++groupindex)
        this.Groups[groupindex].WriteParamHeaders(bw, this.Game, groupindex, position3);
      ...
      for (int groupIndex = 0; groupIndex < this.Groups.Count; ++groupIndex)
        this.Groups[groupIndex].WriteValueIDs(bw, this.Game, groupIndex, position5);
    ...
    public GPARAM.Group this[string name1]
    {
      get
      {
        return this.Groups.Find((Predicate<GPARAM.Group>) (group => group.Name1 == name1));
      }
    }
    ...
    public class Group
    {
      ...
      internal Group(BinaryReaderEx br, GPARAM.GPGame game, int index, GPARAM.Offsets offsets)
      {
      ...
      {
        bw.ReserveInt32(string.Format("GroupHeaderOffset{0}", (object) groupIndex));
      }
      ...
      {
        bw.FillInt32(string.Format("GroupHeaderOffset{0}", (object) groupIndex), (int) bw.Position - groupHeadersOffset);
        bw.WriteInt32(this.Params.Count);
        bw.ReserveInt32(string.Format("ParamHeaderOffsetsOffset{0}", (object) groupIndex));
        if (game == GPARAM.GPGame.DarkSouls2)
        {
      ...
      {
        bw.FillInt32(string.Format("ParamHeaderOffsetsOffset{0}", (object) groupIndex), (int) bw.Position - paramHeaderOffsetsOffset);
        for (int paramIndex = 0; paramIndex < this.Params.Count; ++paramIndex)
          this.Params[paramIndex].WriteParamHeaderOffset(bw, groupIndex, paramIndex);
      }
      ...
      {
        for (int paramIndex = 0; paramIndex < this.Params.Count; ++paramIndex)
          this.Params[paramIndex].WriteParamHeader(bw, game, groupindex, paramIndex, paramHeadersOffset);
      }

      internal void WriteValues(BinaryWriterEx bw, int groupindex, int valuesOffset)
      {
        for (int paramIndex = 0; paramIndex < this.Params.Count; ++paramIndex)
          this.Params[paramIndex].WriteValues(bw, groupindex, paramIndex, valuesOffset);
      }
      ...
      {
        for (int paramIndex = 0; paramIndex < this.Params.Count; ++paramIndex)
          this.Params[paramIndex].WriteValueIDs(bw, game, groupIndex, paramIndex, valueIDsOffset);
      }

      internal void WriteCommentOffsetsOffset(BinaryWriterEx bw, int index)
      {
        bw.ReserveInt32(string.Format("CommentOffsetsOffset{0}", (object) index));
      }

      internal void WriteCommentOffsets(BinaryWriterEx bw, int index, int commentOffsetsOffset)
      {
        bw.FillInt32(string.Format("CommentOffsetsOffset{0}", (object) index), (int) bw.Position - commentOffsetsOffset);
        for (int index1 = 0; index1 < this.Comments.Count; ++index1)
          bw.ReserveInt32(string.Format("CommentOffset{0}:{1}", (object) index, (object) index1));
      }
      ...
      internal void WriteComments(BinaryWriterEx bw, int index, int commentsOffset)
      {
        for (int index1 = 0; index1 < this.Comments.Count; ++index1)
        {
          bw.FillInt32(string.Format("CommentOffset{0}:{1}", (object) index, (object) index1), (int) bw.Position - commentsOffset);
      ...
      public GPARAM.Param this[string name1]
      {
        get
        {
          return this.Params.Find((Predicate<GPARAM.Param>) (param => param.Name1 == name1));
        }
      }

      public override string ToString()
      {
        return this.Name2 == null ? this.Name1 : this.Name1 + " | " + this.Name2;
      }
    }
    ...
    public class Param
    {
      ...
      internal Param(BinaryReaderEx br, GPARAM.GPGame game, GPARAM.Offsets offsets)
      {
        int num1 = br.ReadInt32();
        ...
        this.UnkFloats = game != GPARAM.GPGame.Sekiro ? (List<float>) null : new List<float>((int) num4);
        for (int index = 0; index < (int) num4; ++index)
        {
      ...
      {
        bw.ReserveInt32(string.Format("ParamHeaderOffset{0}:{1}", (object) groupIndex, (object) paramIndex));
      }
      ...
      internal void WriteParamHeader(
        ...
        int paramHeadersOffset)
      {
        bw.FillInt32(string.Format("ParamHeaderOffset{0}:{1}", (object) groupIndex, (object) paramIndex), (int) bw.Position - paramHeadersOffset);
        bw.ReserveInt32(string.Format("ValuesOffset{0}:{1}", (object) groupIndex, (object) paramIndex));
        bw.ReserveInt32(string.Format("ValueIDsOffset{0}:{1}", (object) groupIndex, (object) paramIndex));
      ...
      internal void WriteValues(
        ...
        int valuesOffset)
      {
        bw.FillInt32(string.Format("ValuesOffset{0}:{1}", (object) groupIndex, (object) paramIndex), (int) bw.Position - valuesOffset);
      ...
      internal void WriteValueIDs(
        ...
        int valueIDsOffset)
      {
        bw.FillInt32(string.Format("ValueIDsOffset{0}:{1}", (object) groupIndex, (object) paramIndex), (int) bw.Position - valueIDsOffset);
    ...
    public class Unk3
    {
      ...
      internal Unk3(BinaryReaderEx br, GPARAM.GPGame game, GPARAM.Offsets offsets)
      {
        ...
        this.ValueIDs = new List<int>((IEnumerable<int>) br.GetInt32s((long) offsets.Unk3ValueIDs + (long) num, count));
      }

      internal void WriteHeader(BinaryWriterEx bw, GPARAM.GPGame game, int index)
      {
        ...
        int unk3ValueIDsOffset)
      {
        ...
        {
          bw.FillInt32(string.Format("Unk3ValueIDsOffset{0}", (object) index), 0);
        }
        else
        {
          bw.FillInt32(string.Format("Unk3ValueIDsOffset{0}", (object) index), (int) bw.Position - unk3ValueIDsOffset);
