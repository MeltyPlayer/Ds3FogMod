...
namespace SoulsFormats
{
  ...
  public class BinaryReaderEx
  {
    ...
    private T AssertValue<T>(T value, string typeName, string valueFormat, T[] options) where T : IEquatable<T>
    {
      ...
      string str2 = string.Join(", ", ((IEnumerable<T>) options).Select<T, string>((Func<T, string>) (o => string.Format(valueFormat, (object) o))));
      throw new InvalidDataException(string.Format("Read {0}: {1} | Expected: {2} | Ending position: 0x{3:X}", (object) typeName, (object) str1, (object) str2, (object) this.Position));
    }
    ...
    public void Pad(int align)
    {
      if (this.Stream.Position % (long) align <= 0L)
        return;
      this.Stream.Position += (long) align - this.Stream.Position % (long) align;
    }
    ...
    public bool ReadBoolean()
    {
      ...
      switch (num)
      {
        ...
        case 1:
          return true;
        default:
          throw new InvalidDataException(string.Format("ReadBoolean encountered non-boolean value: 0x{0:X2}", (object) num));
      }
    }
    ...
    {
      return this.GetValues<bool>(new Func<int, bool[]>(this.ReadBooleans), offset, count);
    }

    public bool AssertBoolean(bool option)
    {
      return this.AssertValue<bool>((this.ReadBoolean() ? 1 : 0) != 0, "Boolean", "{0}", new bool[1]
      {
        option
      });
    }
    ...
    {
      return this.GetValues<sbyte>(new Func<int, sbyte[]>(this.ReadSBytes), offset, count);
    }

    public sbyte AssertSByte(params sbyte[] options)
    {
      return this.AssertValue<sbyte>(this.ReadSByte(), "SByte", "0x{0:X}", options);
    }
    ...
    {
      return this.AssertValue<byte>(this.ReadByte(), "Byte", "0x{0:X}", options);
    }

    public short ReadInt16()
    {
      return this.BigEndian ? BitConverter.ToInt16(this.ReadReversedBytes(2), 0) : this.br.ReadInt16();
    }
    ...
    {
      return this.GetValues<short>(new Func<int, short[]>(this.ReadInt16s), offset, count);
    }

    public short AssertInt16(params short[] options)
    {
      return this.AssertValue<short>(this.ReadInt16(), "Int16", "0x{0:X}", options);
    }

    public ushort ReadUInt16()
    {
      return this.BigEndian ? BitConverter.ToUInt16(this.ReadReversedBytes(2), 0) : this.br.ReadUInt16();
    }
    ...
    {
      return this.GetValues<ushort>(new Func<int, ushort[]>(this.ReadUInt16s), offset, count);
    }

    public ushort AssertUInt16(params ushort[] options)
    {
      return this.AssertValue<ushort>(this.ReadUInt16(), "UInt16", "0x{0:X}", options);
    }

    public int ReadInt32()
    {
      return this.BigEndian ? BitConverter.ToInt32(this.ReadReversedBytes(4), 0) : this.br.ReadInt32();
    }
    ...
    {
      return this.GetValues<int>(new Func<int, int[]>(this.ReadInt32s), offset, count);
    }

    public int AssertInt32(params int[] options)
    {
      return this.AssertValue<int>(this.ReadInt32(), "Int32", "0x{0:X}", options);
    }

    public uint ReadUInt32()
    {
      return this.BigEndian ? BitConverter.ToUInt32(this.ReadReversedBytes(4), 0) : this.br.ReadUInt32();
    }
    ...
    {
      return this.GetValues<uint>(new Func<int, uint[]>(this.ReadUInt32s), offset, count);
    }

    public uint AssertUInt32(params uint[] options)
    {
      return this.AssertValue<uint>(this.ReadUInt32(), "UInt32", "0x{0:X}", options);
    }

    public long ReadInt64()
    {
      return this.BigEndian ? BitConverter.ToInt64(this.ReadReversedBytes(8), 0) : this.br.ReadInt64();
    }
    ...
    {
      return this.GetValues<long>(new Func<int, long[]>(this.ReadInt64s), offset, count);
    }

    public long AssertInt64(params long[] options)
    {
      return this.AssertValue<long>(this.ReadInt64(), "Int64", "0x{0:X}", options);
    }

    public ulong ReadUInt64()
    {
      return this.BigEndian ? BitConverter.ToUInt64(this.ReadReversedBytes(8), 0) : this.br.ReadUInt64();
    }
    ...
    {
      return this.GetValues<ulong>(new Func<int, ulong[]>(this.ReadUInt64s), offset, count);
    }

    public ulong AssertUInt64(params ulong[] options)
    {
      return this.AssertValue<ulong>(this.ReadUInt64(), "UInt64", "0x{0:X}", options);
    }
    ...
    public long[] ReadVarints(int count)
    {
      long[] numArray = new long[count];
      for (int index = 0; index < count; ++index)
        numArray[index] = !this.VarintLong ? (long) this.ReadInt32() : this.ReadInt64();
      return numArray;
    }

    public long GetVarint(long offset)
    {
      return this.VarintLong ? this.GetInt64(offset) : (long) this.GetInt32(offset);
    }

    public long[] GetVarints(long offset, int count)
    {
      return this.GetValues<long>(new Func<int, long[]>(this.ReadVarints), offset, count);
    }

    public long AssertVarint(params long[] options)
    {
      return this.AssertValue<long>(this.ReadVarint(), this.VarintLong ? "Varint64" : "Varint32", "0x{0:X}", options);
    }

    public float ReadSingle()
    {
      return this.BigEndian ? BitConverter.ToSingle(this.ReadReversedBytes(4), 0) : this.br.ReadSingle();
    }
    ...
    {
      return this.GetValues<float>(new Func<int, float[]>(this.ReadSingles), offset, count);
    }

    public float AssertSingle(params float[] options)
    {
      return this.AssertValue<float>(this.ReadSingle(), "Single", "{0}", options);
    }

    public double ReadDouble()
    {
      return this.BigEndian ? BitConverter.ToDouble(this.ReadReversedBytes(8), 0) : this.br.ReadDouble();
    }
    ...
    {
      return this.GetValues<double>(new Func<int, double[]>(this.ReadDoubles), offset, count);
    }

    public double AssertDouble(params double[] options)
    {
      return this.AssertValue<double>(this.ReadDouble(), "Double", "{0}", options);
    }
    ...
    private TEnum ReadEnum<TEnum, TValue>(Func<TValue> readValue, string valueFormat)
    {
      ...
      if (!System.Enum.IsDefined(typeof (TEnum), (object) obj))
        throw new InvalidDataException(string.Format("Read Byte not present in enum: {0}", (object) string.Format(valueFormat, (object) obj)));
      return (TEnum) (object) obj;
    }

    public TEnum ReadEnum8<TEnum>() where TEnum : System.Enum
    {
      return this.ReadEnum<TEnum, byte>(new Func<byte>(this.ReadByte), "0x{0:X}");
    }
    ...
    {
      return this.ReadEnum<TEnum, ushort>(new Func<ushort>(this.ReadUInt16), "0x{0:X}");
    }
    ...
    {
      return this.ReadEnum<TEnum, uint>(new Func<uint>(this.ReadUInt32), "0x{0:X}");
    }
    ...
    {
      return this.ReadEnum<TEnum, ulong>(new Func<ulong>(this.ReadUInt64), "0x{0:X}");
    }
    ...
    public string AssertASCII(params string[] values)
    {
      ...
      if (!flag)
        throw new InvalidDataException(string.Format("Read ASCII: {0} | Expected ASCII: {1}", (object) str1, (object) string.Join(", ", values)));
      return str1;
    }
    ...
    {
      List<byte> byteList = new List<byte>();
      for (byte[] numArray = this.ReadBytes(2); numArray[0] != (byte) 0 || numArray[1] != (byte) 0; numArray = this.ReadBytes(2))
      {
        byteList.Add(numArray[0]);
        byteList.Add(numArray[1]);
      }
      return this.BigEndian ? SFEncoding.UTF16BE.GetString(byteList.ToArray()) : SFEncoding.UTF16.GetString(byteList.ToArray());
    }
    ...
    public string ReadFixStrW(int size)
    {
      ...
      return this.BigEndian ? SFEncoding.UTF16BE.GetString(bytes, 0, count) : SFEncoding.UTF16.GetString(bytes, 0, count);
    }
    ...
    public Vector4 ReadVector4()
    {
      ...
      return new Vector4((float) num1, (float) num5, (float) num6, (float) num7);
    }
    ...
    public void AssertPattern(int length, byte pattern)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        if ((int) numArray[index] != (int) pattern)
          throw new InvalidDataException(string.Format("Expected {0} 0x{1:X2}, got {2:X2} at position {3}", (object) length, (object) pattern, (object) numArray[index], (object) index));
      }
    }
    ...
    {
      return Color.FromArgb((int) this.br.ReadByte(), (int) this.br.ReadByte(), (int) this.br.ReadByte(), (int) this.br.ReadByte());
    }
