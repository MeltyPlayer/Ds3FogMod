...
namespace SoulsFormats
{
  ...
  public class BND3 : SoulsFile<BND3>, IBinder, IBND3
  {
    ...
    {
      List<BinderFileHeader> binderFileHeaderList = BND3.ReadHeader((IBND3) this, br);
      ...
      BinaryReaderEx br)
    {
      ...
      for (int index = 0; index < capacity; ++index)
        binderFileHeaderList.Add(BinderFileHeader.ReadBinder3FileHeader(br, bnd.Format, bnd.BitBigEndian));
    ...
    protected override void Write(BinaryWriterEx bw)
    {
      ...
      for (int index = 0; index < this.Files.Count; ++index)
        fileHeaders[index].WriteBinder3FileData(bw, bw, this.Format, index, this.Files[index].Bytes);
    }
      ...
      List<BinderFileHeader> fileHeaders)
    {
      ...
      for (int index = 0; index < fileHeaders.Count; ++index)
        fileHeaders[index].WriteBinder3FileHeader(bw, bnd.Format, bnd.BitBigEndian, index);
      for (int index = 0; index < fileHeaders.Count; ++index)
